    ...
    switch (currentView) {
      case 'Today':
        return tasks.filter(task => {
          ...
          if (task.priority === 'SOMEDAY') return false;
      ...
      case 'Calendar':
        return tasks.filter(task => !task.completed && task.priority !== 'SOMEDAY');
      ...
      <div className="max-w-[1400px] mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-1 mb-4">
            {['Today', 'Calendar', 'This Week', 'Someday', 'All', 'Done'].map((view) => (
              <button
                key={view}
          ...
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-semibold">
                ...
                {currentView === 'Someday' && 'Someday Tasks'}
              ...
              <p className="text-gray-500 mt-1">
                ...
                {currentView === 'This Week' && `${filteredTasks.length} tasks in the next 7 days`}
                {currentView === 'Someday' && `${filteredTasks.length} tasks for someday`}
